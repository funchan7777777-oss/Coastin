...
class ShoreMomentHarborCatalog {
  ...
  static const List<ShorelinePersona> shorelinePeople = [
    ...
    ShorelinePersona(
      ...
      displayHarborName: 'Liora Westin',
    ...
    ShorelinePersona(
      ...
      displayHarborName: 'Finley Calder',
    ...
    ShorelinePersona(
      ...
      displayHarborName: 'Riven Brooks',
